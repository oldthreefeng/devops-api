LDFLAGS += -X "github.com/oldthreefeng/devops-api/common.BuildDate=$(shell date -u '+%Y-%m-%d %H:%M:%S %Z')"
LDFLAGS += -X "github.com/oldthreefeng/devops-api/common.CommitHash=$(shell git rev-parse --short HEAD)"
LDFLAGS += -X "github.com/oldthreefeng/devops-api/common.GoVersion=$(shell go version)"
